        ...
        examples: [
            {
                ...
                text: (
                    <>
                        <p>
                            &nbsp;&nbsp;&nbsp;&nbsp;<strong>Ремонт принтеров LaserJet 1010</strong> процесс, знакомый многим. В интернете множество предложений по заправке данных картриджей, в том числе с очень заниженной ценой, что привлекает клиентов, конечно же. Помимо этого, в интернетах множество примеров как <strong>заправить картридж HP CF281A</strong>.

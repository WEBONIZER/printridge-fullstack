// Функция для определения типа прайса принтера на основе параметров (для frontend)
...
// Функция для определения типа прайса ноутбука на основе параметров (для frontend)
